...
<html>
	<head>
		...
		<?php
//        if($this->session->userdata($this->site . 'isLogin')==true){ redirect('site/dashboard'); }
        ?>
		...
		<div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-heading text-center" style="background-color: white; height: 150px">
                    <img style="max-height: 100px; max-width: 300px" src="<?=$this->config->item('url').$site->logo?>">
				...
				<?=form_open('site/log_in', array('class'=>'form-horizontal m-t-20'))?>
                    ...
                    <div class="form-group text-center m-t-40">
                        <div class="col-xs-12">
                            <button class="btn btn-primary btn-lg w-lg waves-effect waves-light" type="submit" name="login">LOGIN</button>
                        </div>
                    </div>
